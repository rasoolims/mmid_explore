...
for c, wiki_dump_file in enumerate(os.listdir(wiki_folder)):
    ...
    os.system('grep  --ignore-case  ".png" ' + os.path.join(wiki_folder, wiki_dump_file)+' > ' + os.path.join(lang_out_folder, lang+".png.txt &"))
    os.system('grep  --ignore-case  ".svg" ' + os.path.join(wiki_folder, wiki_dump_file)+' > ' + os.path.join(lang_out_folder, lang+".svg.txt &"))
    os.system('grep  --ignore-case  ".jpeg" ' + os.path.join(wiki_folder, wiki_dump_file)+' > ' + os.path.join(lang_out_folder, lang+".jpeg.txt &"))
    if c%10==0:
        os.system('grep  --ignore-case  ".jpg" ' + os.path.join(wiki_folder, wiki_dump_file)+' > ' + os.path.join(lang_out_folder, lang+".jpg.txt"))
    else:
